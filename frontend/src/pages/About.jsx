  ...
  return (
    <section className="bg-white py-16 px-4 md:px-12 text-center">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        />
        <h1 className="text-5xl font-bold mt-4">Nofffie</h1>
        <p className="text-lg text-gray-500 mt-1">Full Stack Developer / Trader / Financial Advisor</p>
        <p className="text-lg text-gray-500">Building tech with a purpose and financial freedom in mind</p>

        {/* Buttons */}
        <div className="flex justify-center gap-4 mt-6">
          <a
            href="#"
            className="px-5 py-2 border border-gray-400 rounded-full text-lg hover:bg-gray-100"
          >
            Download CV
          </a>
          <a
            href="/contact"
            className="px-5 py-2 border border-gray-800 bg-gray-800 text-white rounded-full text-lg hover:bg-gray-700"
          >
            Contact
          </a>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-16 text-left">
        <div>
          <h2 className="text-2xl font-semibold mb-3">Design & Code</h2>
      ...
      {/* Quote */}
      <div className="bg-gray-100 max-w-3xl mx-auto mt-16 p-6 rounded-md text-gray-600 italic flex items-start gap-3 text-2xl">
        "I’m not just building a career, I’m building freedom, tools for people, and a future for my family."
      </div>

      {/* Stats */}
      <div className="flex flex-wrap justify-center gap-6 mt-12">
        <div className="bg-[#F4F4F4] px-6 py-4 rounded shadow text-center w-50">
          <p className="font-bold text-2xl text-gray-800">5+</p>
          <p className="text-lg text-gray-500">Projects Running</p>
        </div>
        <div className="bg-[#F4F4F4] px-6 py-4 rounded shadow text-center w-50">
          <p className="font-bold text-2xl text-gray-800">3 Roles</p>
          <p className="text-lg text-gray-500">Developer <br /> Trader / Advisor</p>
        </div>
        <div className="bg-[#F4F4F4] px-6 py-4 rounded shadow text-center w-50">
          <p className="font-bold text-2xl text-gray-800">10 Yrs</p>
          <p className="text-lg text-gray-500">Entrepreneurship</p>
        </div>
      </div>
    </section>
  );
